...
def generate_complete_pdf_report(analysis_data):
    ...
    story.append(Paragraph("ColorSync Access - Complete Analysis Report", title_style))
    ...
    <br/>
    <i>Report generated by ColorSync Access Professional Edition | © 2025 ColorSync Access</i>
    """
